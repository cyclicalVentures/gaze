...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      ...
      setCentering(null);
      if (tracker.current?.calibrate()) { engine.current?.calibrateOrigin(); setNote('Eye centers and gaze direction set. Move gently to look into the box.'); }
